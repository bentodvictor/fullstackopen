...
const mostBlogs = (blogs) => {
    ...
    const authorMostBlogs = _.reduce(authorBlogs, (result, value, key) => {
...
const mostLikes = (blogs) => {
    ...
    const authorMostLikes = _.reduce(authorLikes, (result, value, key) => {
        const currentTotalLikes = value.reduce((acc, current) => acc + current.likes, 0)
